    ...
    return (
        <section className="flex flex-col justify-between">
            <div className="flex flex-col items-center justify-around h-1/4">
                <h1 className="text-[2rem] text-gray-50 text-center font-bold translate-y-80 -z-10">Cómo comprar y vender?</h1>
            ...
            <div className="flex flex-col items-center justify-around h-20 p-3">
                <p className="text-sm text-gray-800 text-center font-semibold">Aquí te explicamos cómo funcionan nuestros procesos de compra y venta para que puedas aprovechar al máximo nuestro servicio .</p>
            </div>
            <div className="flex flex-col items-center justify-around h-1/4 p-3">
                <h2 className="text-2xl text-gray-800 text-center font-semibold">Cómo comprar?</h2>
                <p className="text-sm text-gray-800 text-center font-semibold">Navega por nuestra amplia selección de ropa de segunda mano y encuentra las mejores prendas a los mejores precios .
            ...
            <div className="flex flex-col items-center justify-around h-1/4 p-3">
                <h2 className="text-2xl text-gray-800 text-center font-semibold">Cómo vender?</h2>
                <p className="text-sm text-gray-800 text-center font-semibold">Regístrate en nuestro sitio web y crea tu cuenta.
