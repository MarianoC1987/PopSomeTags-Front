            ...
            <header>
                ...
                <div className="group">
                    ...
                    <div className="popover">
                        <button>User Name<img src={chdown} /></button>
                        <div className="menu">
                            <button>
                                <img id="user-avatar" src={avatar} />
                                <span id="user-profile">Hola, User<span id="user-mail">user mail</span></span>
                            </button>
                ...
                <nav>
                    <div className="popover">
                        <button><h2>TIENDA</h2><img src={chdown} /></button>
                    ...
                    <button><h2>COMO FUNCIONA</h2></button>
                    <button><h2>SOBRE NOSOTROS</h2></button>
                    <button><h2>BLOG</h2></button>
