      ...
      <container className="flex items-center justify-between w-screen h-3/5">
        <div className="flex w-6/12">
          <p className="text-sm text-start text-gray-800 p-3">
            ¡Hola! Bienvenidos a nuestra tienda de moda circular. Te contaremos
            un poco sobre nosotros y nuestra misión.
            <br />
            <br />
            ...
            contribuir a la reducción de la huella ambiental de la industria de
            la moda y fomentar un consumo responsable y ético.
            <br />
            <br />
            En nuestra tienda encontrarás prendas de segunda mano de alta
            calidad, seleccionadas cuidadosamente para garantizar su durabilidad
            y estilo atemporal. Además, ofrecemos una amplia variedad de estilos
            y tallas, para que todas y todos puedan encontrar algo que les
            guste.
            <br />
            <br />
